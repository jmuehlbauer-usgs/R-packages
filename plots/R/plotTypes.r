...
#'
#' To save an R plot window as a \code{.ppt} file (very useful for creating presentations), see function \code{graph2ppt} in package \code{export} (\code{https://github.com/tomwenseleers/export}).
